...
const API_SOLICITUDES = "https://34.123.227.162:8443/api/solicitudes/resumen";
...
export const aprobarSolicitud = async (idSolicitud) => {
    ...
    try {
        ...
        const response = await axios.post(
            `https://34.123.227.162:8443/api/solicitudes-sin-responder/aprobar/${idSolicitud}`, 
...
export const rechazarSolicitud = async (idSolicitud, motivo) => {
    try {
        const response = await axios.post(
            `https://34.123.227.162:8443/api/solicitudes-sin-responder/rechazar/${idSolicitud}`, 
            motivo,
            {
                headers: {
...
export const addSolicitud = async (solicitudData) => {
    try {
        const response = await axios.post("https://34.123.227.162:8443/api/solicitudes-sin-responder/crear-completa", solicitudData, {
            headers: {
